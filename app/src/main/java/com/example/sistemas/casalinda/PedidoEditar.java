    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (connect == null) {
                ...
                total = String.valueOf((double) Math.round((Double.valueOf(getIntent().getStringExtra(TOT))) * 100d) / 100d);
                //total = valueOf( ((Double.valueOf(getIntent().getStringExtra(TOT))) * 100.0) / 100.0);
                    ...
                    public void onTextChanged(CharSequence s, int start, int before, int count) {
                        try {
                            ...
                            if (unitario.equals("") || Double.parseDouble(unitario) < Double.parseDouble(pon)) {
                                ...
                                total = format( "%.2f",(Double.valueOf(cantidad) * Double.valueOf(unitario)));
                                tvTotal.setText(total);
                            }
                        } catch (Exception e) {
                            salir(e.getMessage());
                            ...
                            if (cantidadN.equals("") || Double.parseDouble(cantidadN) <= 0) {
                                ...
                                if ((unitario.equals("")) || (u <= p)) {
                                    ...
                                    if (cn <= Double.parseDouble(inventario)) {
                                        total = valueOf((double) Math.round((Double.valueOf(cantidadN) * Double.valueOf(unitario)) * 100d) / 100d);
                                        tvTotal.setText(total);
                                    } else {
